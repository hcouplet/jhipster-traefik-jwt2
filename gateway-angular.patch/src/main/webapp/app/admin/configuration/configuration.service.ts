...
export class JhiConfigurationService {
    ...
    get(): Observable<any> {
        return this.http.get(SERVER_UAA_API_URL + 'management/configprops').map((res: Response) => {
    ...
    getEnv(): Observable<any> {
        return this.http.get(SERVER_UAA_API_URL + 'management/env').map((res: Response) => {
            const properties: any = {};
